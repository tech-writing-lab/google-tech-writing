...
![圖 1. 好的圖像能以文字無法達到的方式吸引讀者。](images/book_readers.jpg){fig-alt="Three children read a book while pointing at the pictures."}

圖片來源：Nirmal Dulal [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0)
...
![](images/caption_exercise_chain_a.png){width=500 fig-alt="Multicolored chain"}

**圖說 A. 單向鏈結串列的節點會儲存資料內容，以及指向下一個節點的參考。**

<br /><br />

![](images/caption_exercise_drawing_b.png){width=480 fig-alt="Four boxes connected by three arrows"}

**圖說 B. 單向鏈結串列的節點會儲存資料內容，以及指向下一個節點的參考。**

<br />

![](images/caption_exercise_drawing_c.svg){width=700 fig-alt="Four boxes (each with content and a pointer) connected by three arrows."}
...
![](images/van_gogh.jpg){fig-alt="Portrait of Pere Tanguy By Vincent van Gogh - Musée Rodin"}
...
![](images/overly_complex_diagram.svg){fig-alt="A schematic, filled with lines and small print"}
...
**下個單元：** [建立範例程式碼](../sample-code/index.qmd)
