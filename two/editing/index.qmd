...
**備註：** 本單元的內容是以《技術寫作一》的基礎寫作和編輯技巧為基礎，可說是總結了該課程的實用編輯技巧。本單元包含該課程中有用的編輯技巧摘要。如需更詳細的複習，請參閱[《技術寫作一》](../../one/introduction/index.qmd)的自學單元。
...
* 使用[主動語態](../../one/active-voice/index.qmd)來明確表示誰在執行該動作。
* 將連續步驟格式化為[編號清單](../../one/lists-and-tables/index.qmd)。
* 將大多數其他清單格式化為項目符號清單。
...
如需複習和更多關於此主題的資訊，請參閱《技術寫作一》中的「[目標讀者](../../one/audience/index.qmd)」自學單元。
...
**下一單元：** [組織大型文件](../large-docs/index.qmd)
