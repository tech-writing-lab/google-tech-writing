...
::: {.callout-note}
此中文版初次發布的時間為 2025 年 7 月。原本是用 Hugo 生成網站，每個頁面的最底下都有顯示最近一次的更新日期，可以跟原文課程的每一個頁面下方的更新日期比對，便可判斷中文版內容是否需要更新。然而，後來我改用 Quarto，其[「last-modified」功能仍有問題尚待解決](https://github.com/quarto-dev/quarto-cli/issues/5967)，故暫且無法顯示每頁的最近更新時間。
:::

## 開始課程

接著，請從這裡開始學習這門課程：[技術寫作 (一)](one/introduction/index.qmd)
