...
::: {.callout-note}
### Feedback
如對此中文版有任何建議或指正，歡迎[至 GitHub Issues 提交問題單](https://github.com/tech-writing-lab/google-tech-writing/issues){target="_blank"}。
:::

## 開始課程

接著，請從這裡開始學習這門課程：[技術寫作一]({{< relref "one/introduction/index.md" >}})
